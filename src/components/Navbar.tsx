...
const Navbar: React.FC<NavbarProps> = () => {
   const router = useRouter();
    ...
    return ( 
        ...
        <>
        <div className="relative bg-smoke w-full flex justify-center">
          {/* width: 66vw;
    margin-inline: 17vw; // 34 vw
    padding-block: 1vw; */}
          <nav className="lg:absolute flex justify-between items-center lg:w-[66vw] mx-auto py-[1vw]">
            <div className="nav-brand mt-3 !w-[3.5rem] lg:mt-0 !lg:w-[6rem] hidden lg:block">
        ...
        >
          <div className="nav-brand mt-[5rem] lg:mt-0 !w-[5rem] hidden lg:block">
            <Image src="/images/logo.png" alt="bsip logo" fill />
